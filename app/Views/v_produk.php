                     ...
                     foreach ($produk as $key => $value){?>
                        <tr>
                            ...
                            <td class="text-center">
                                 ...
                                 <button type="button"class="btn btn-danger btn-sm btn-flat" data-toggle="modal" data-target="#delete-data<?=$value['id_produk']?>"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input name="harga_beli" class="form-control" onkeyup="hargaJual.value = parseInt(this.value) + (this.value * 25 / 100)"  placeholder="Harga Beli" required>
                </div>
                </div>
                ...
                <input name="stok_produk" type="number" class="form-control"  placeholder="Stok produk" required>   
              </div>
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <div class="form-group">
      ...
      <input name="harga_beli"  class="form-control" onkeyup="hargaJualUbah.value = parseInt(this.value) + (this.value * 25 / 100)" value="<?=$value ['harga_beli']?>"  required>
      </div>
      </div>
      ...
      <input name="stok_produk"   class="form-control" value="<?=$value ['stok_produk']?>" required>
    </div>
...
<?php foreach ($produk as $key => $value) { ?>
        ...
        <div class="modal-content">
          ...
          <?php echo form_open('Produk/DeleteData/'. $value['id_produk'])?>
          <div class="modal-body">
